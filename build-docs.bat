...
if not exist Qt-6.10.0-mingw13.zip (
    echo downloading Qt-6.10.0-mingw13.zip
    curl -L -o Qt-6.10.0-mingw13.zip https://github.com/mugiseyebrows/scoung/releases/download/test/Qt-6.10.0-mingw13.zip
)
...
pushd src
    ...
    ninja install_docs
popd
7z a -y doc.7z C:\qt\6.10.0\mingw_64\doc