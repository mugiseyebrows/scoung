...
set PATH=C:\Windows\System32;C:\Program Files\7-Zip;C:\mingw540_32\bin;C:\Qt\4.8.7-profile\mingw540_32\bin;C:\mysql-5.5.62-win32\lib;C:\mysql-5.5.62-win32\bin;C:\OpenSSL\bin;C:\Strawberry\perl\bin;C:\Miniconda3;C:\Miniconda3\Scripts;%USERPROFILE%\Miniconda3;%USERPROFILE%\Miniconda3\Scripts;%PATH%
...
pushd qt-everywhere-opensource-src-4.8.7
    ...
    configure -prefix C:\Qt\4.8.7-profile\mingw540_32 -opensource -confirm-license -static -platform win32-g++ -opengl desktop -debug %exclude% -plugin-sql-mysql -plugin-sql-odbc -I %MYSQL_INCLUDE% -L %MYSQL_BIN% -I %OPENSSL_INCLUDE% -L %OPENSSL_BIN% -openssl-linked OPENSSL_LIBS="-lssleay32 -llibeay32"
    mingw32-make -j4
...
popd
mugideploy copy-dep --bin C:\Qt\4.8.7-profile\mingw540_32\bin\qmake.exe --dst C:\Qt\4.8.7-profile\mingw540_32\bin
mugideploy copy-dep --bin C:\Qt\4.8.7-profile\mingw540_32\bin\QtNetwork4.dll --dst C:\Qt\4.8.7-profile\mingw540_32\bin
mugideploy copy-dep --bin C:\Qt\4.8.7-profile\mingw540_32\plugins\sqldrivers\qsqlmysql4.dll --dst C:\Qt\4.8.7-profile\mingw540_32\bin
7z a -y Qt-4.8.7.7z C:\Qt\4.8.7-profile\mingw540_32